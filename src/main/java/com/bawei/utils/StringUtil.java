...
public class StringUtil {
	...
	public void testString() {
		...
		String str="1350987876";
		//System.out.println(util.isBlank(str));
		System.out.println(util.isMobile(str));
	}
	/**
	 * 手机号验证
	 * 
	...
	public static boolean isMobile(String str)
	{
		...
		Matcher m = null;
		boolean b = false;
		p = Pattern.compile("^[1][3,4,5,7,8][0-9]{9}$"); // 验证手机号 1[3,4,5,6,7,8]9876545435
		m = p.matcher(str);
		b = m.matches();
		return b;*/
		
		String regString = "^[1][3,4,5,7,8][0-9]{9}$";
		return str.matches(regString);
	}
    ...
    public static void main(String[] args) {
		System.out.println(TrimPunctuation("4:5.6;7"));
	}
}

...
<nav class="navbar navbar-light bg-light">
  ...
  <ul class="nav">
    ...
    <c:when test="${user  != null}">
   	 ...
   	 <li class="nav-item">
		  ...
		  <a href="#" class="nav-link dropdown-toggle" role="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		    <c:out value="${user.nickname}" default="CMS-User"/>
		  </a>
		  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
		    <a class="dropdown-item" href="userhome.do">个人主页</a>
    ...
    <c:otherwise>
      <%-- 未登录显示登录注册链接 --%>
	   <li class="nav-item"><a class="nav-link" href="/reg.do">注册</a></li>
	   <li class="nav-item"><a class="nav-link" href="/login.do">登录</a></li>
     </c:otherwise>
    </c:choose>
  </ul>
</nav>